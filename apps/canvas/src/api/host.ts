/**
 * Host resolution — ported from vector-oracle-studio (local.drizzle.studio pattern).
 *
...
const STORAGE_KEY = 'canvas-oracle-studio-host';
const RECENT_KEY = 'canvas-oracle-studio-host-recent';
